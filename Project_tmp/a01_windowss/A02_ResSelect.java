...
public class A02_ResSelect extends JFrame {
    private JPanel contentPane;
    private JComboBox<String> comboBox;
    private JLabel resultLabel;
    private JTextField textField;
    private JButton btnNewButton;
    private String userId;// 로그인 아이디를 받기 위한 선언
    private String name;
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                A02_ResSelect frame = new A02_ResSelect();
    ...
    public A02_ResSelect() {
		// TODO Auto-generated constructor stub
	}

    public A02_ResSelect(String userId, String name, String phone) {
    	
    	this.userId = userId; // 로그인 아이디를 받고
    	this.name = name;
    	this.phone = phone;
        ...
        btnNewButton.addActionListener(e -> {
            ...
            dispose(); // 현재 창 닫기
            new A03_MenuForm(userId, name, phone, selectedRestId).setVisible(true); // 새로운 메뉴 창 열기
            // 로그인 아이디 + 선택된 레스토랑 아이디와 함께 A03으로 전달
        });
