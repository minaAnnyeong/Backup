...
public class B01_AdminLogin extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                B01_AdminLogin frame = new B01_AdminLogin();
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    if (rs.next()) {
                        ...
                        dispose(); 
                        new B02_Rev_List().setVisible(true); // Rev_List 화면을 새로 엶
