...
public class A01_CustomerLogin extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                A01_CustomerLogin frame = new A01_CustomerLogin();
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                try {
                    ...
                    PreparedStatement pstmt = conn.prepareStatement(
                    	    "SELECT * FROM user_acc WHERE user_id = ? AND user_pw = ?"
                    	);
                    ...
                    if (rs.next()) {
                        ...
                        String userId = rs.getString("user_id");// 로그인 아이디 획득
                        ...
                        dispose(); 
                        new A02_ResSelect(userId,name,phone).setVisible(true); // Rev_List 화면을 새로 엶
                        // 로그인 아이디를 A02로 보냄
