...
//					frame_signupcpl.setResizable(false); // 화면 크기 조정 가능 여부
	...
	public SignupComplete(SignupUserVO signup_info, SignupUserDAO signup_dao) {
		setTitle("회원가입완료");
		...
		btn_confirm.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(null, "가입되었습니다.", "가입완료", JOptionPane.PLAIN_MESSAGE);
				dispose(); 
                new A00_main().setVisible(true);
			}
		});
